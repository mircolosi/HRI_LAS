...
`(rospack find diago_apps)`/script/run_navigation.py diago DISB1 SIM -initpose 2 2 0
...
rostopic pub /diago/planToExec std_msgs/String "data: 'go_and_follow_person'"  --once
