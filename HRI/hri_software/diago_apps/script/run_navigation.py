...
if __name__ == '__main__':
  ...
  cmd = 'xterm -e roslaunch diago_apps diago_nav.launch robot_name:=%s map_name:=%s use_joystick:=true initial_pose_x:=%f  initial_pose_y:=%f initial_pose_a:=%f &' % (params['robotname'], params['mapname'], params['init_x'], params['init_y'], init_th_rad)
  print cmd
  os.system(cmd)
  os.system('sleep 5')  
