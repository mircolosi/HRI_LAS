...
"""autogenerated by genpy from pnp_msgs/PNPActionResult.msg. Do not edit."""
import sys
...
class PNPActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "pnp_msgs/PNPActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pnp_msgs/PNPResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PNPActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pnp_msgs.msg.PNPResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pnp_msgs.msg.PNPResult()
