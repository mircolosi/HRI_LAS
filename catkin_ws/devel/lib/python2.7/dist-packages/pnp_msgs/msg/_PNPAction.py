...
"""autogenerated by genpy from pnp_msgs/PNPAction.msg. Do not edit."""
import sys
...
class PNPAction(genpy.Message):
  _md5sum = "7164fe8652397bee332b667276ea3424"
  _type = "pnp_msgs/PNPAction"
...
"""
  ...
  _slot_types = ['pnp_msgs/PNPActionGoal','pnp_msgs/PNPActionResult','pnp_msgs/PNPActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PNPAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pnp_msgs.msg.PNPActionGoal()
      if self.action_result is None:
        self.action_result = pnp_msgs.msg.PNPActionResult()
      if self.action_feedback is None:
        self.action_feedback = pnp_msgs.msg.PNPActionFeedback()
    else:
      self.action_goal = pnp_msgs.msg.PNPActionGoal()
      self.action_result = pnp_msgs.msg.PNPActionResult()
      self.action_feedback = pnp_msgs.msg.PNPActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_I.pack(self.action_goal.goal.id))
      _x = self.action_goal.goal.robotname
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.params
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.id,) = _struct_I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.robotname = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.robotname = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.params = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.params = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
