...
"""autogenerated by genpy from rococo_navigation/FollowPersonActionResult.msg. Do not edit."""
import sys
...
class FollowPersonActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "rococo_navigation/FollowPersonActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rococo_navigation/FollowPersonResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowPersonActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rococo_navigation.msg.FollowPersonResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rococo_navigation.msg.FollowPersonResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.result = str[start:end].decode('utf-8')
      else:
