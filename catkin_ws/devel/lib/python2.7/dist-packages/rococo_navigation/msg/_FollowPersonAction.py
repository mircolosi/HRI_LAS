...
"""autogenerated by genpy from rococo_navigation/FollowPersonAction.msg. Do not edit."""
import sys
...
class FollowPersonAction(genpy.Message):
  _md5sum = "f6ced0885900cf6f54cda67aec93d91c"
  _type = "rococo_navigation/FollowPersonAction"
...
"""
  ...
  _slot_types = ['rococo_navigation/FollowPersonActionGoal','rococo_navigation/FollowPersonActionResult','rococo_navigation/FollowPersonActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowPersonAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = rococo_navigation.msg.FollowPersonActionGoal()
      if self.action_result is None:
        self.action_result = rococo_navigation.msg.FollowPersonActionResult()
      if self.action_feedback is None:
        self.action_feedback = rococo_navigation.msg.FollowPersonActionFeedback()
    else:
      self.action_goal = rococo_navigation.msg.FollowPersonActionGoal()
      self.action_result = rococo_navigation.msg.FollowPersonActionResult()
      self.action_feedback = rococo_navigation.msg.FollowPersonActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3f3I.pack(_x.action_goal.goal.target_X, _x.action_goal.goal.target_Y, _x.action_goal.goal.max_vel, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.target_X, _x.action_goal.goal.target_Y, _x.action_goal.goal.max_vel, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
