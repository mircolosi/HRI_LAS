...
"""autogenerated by genpy from rococo_navigation/FollowCorridorActionResult.msg. Do not edit."""
import sys
...
class FollowCorridorActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "rococo_navigation/FollowCorridorActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rococo_navigation/FollowCorridorResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowCorridorActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rococo_navigation.msg.FollowCorridorResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rococo_navigation.msg.FollowCorridorResult()
