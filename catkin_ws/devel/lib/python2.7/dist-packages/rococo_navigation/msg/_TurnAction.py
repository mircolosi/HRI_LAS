...
"""autogenerated by genpy from rococo_navigation/TurnAction.msg. Do not edit."""
import sys
...
class TurnAction(genpy.Message):
  _md5sum = "29900bb378012fce449b2694fabd5bc8"
  _type = "rococo_navigation/TurnAction"
...
"""
  ...
  _slot_types = ['rococo_navigation/TurnActionGoal','rococo_navigation/TurnActionResult','rococo_navigation/TurnActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = rococo_navigation.msg.TurnActionGoal()
      if self.action_result is None:
        self.action_result = rococo_navigation.msg.TurnActionResult()
      if self.action_feedback is None:
        self.action_feedback = rococo_navigation.msg.TurnActionFeedback()
    else:
      self.action_goal = rococo_navigation.msg.TurnActionGoal()
      self.action_result = rococo_navigation.msg.TurnActionResult()
      self.action_feedback = rococo_navigation.msg.TurnActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.action_goal.goal.target_angle))
      _x = self.action_goal.goal.absolute_relative_flag
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_f3I.pack(_x.action_goal.goal.max_ang_vel, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.target_angle,) = _struct_f.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.absolute_relative_flag = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.absolute_relative_flag = str[start:end]
      _x = self
      start = end
      end += 16
      (_x.action_goal.goal.max_ang_vel, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
