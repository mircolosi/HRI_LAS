...
"""autogenerated by genpy from rococo_navigation/TurnActionResult.msg. Do not edit."""
import sys
...
class TurnActionResult(genpy.Message):
  ...
  _type = "rococo_navigation/TurnActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rococo_navigation/TurnResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = rococo_navigation.msg.TurnResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rococo_navigation.msg.TurnResult()
